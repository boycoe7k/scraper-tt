...
module.exports = {
  ...
  sourceUrls: (process.env.SOURCE_URLS || "https://www5.zimsec.co.zw/download-category/a-level/,https://www5.zimsec.co.zw/download-category/specimen-papers/").split(",").map(url => url.trim()).filter(Boolean),
