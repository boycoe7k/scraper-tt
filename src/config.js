...
module.exports = {
  ...
  sourceUrls: (process.env.SOURCE_URLS || "https://www5.zimsec.co.zw/download-category/a-level/,https://www5.zimsec.co.zw/download-category/specimen-papers/,https://zimsecpapers.github.io/").split(",").map(url => url.trim()).filter(Boolean),
  ...
  requestTimeout: Number(process.env.REQUEST_TIMEOUT_MS || 20000),
